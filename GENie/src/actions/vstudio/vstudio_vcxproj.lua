...
--
	...
	function vc2010.configurationPropertyGroup(cfg, cfginfo)
		...
		if cfg.flags.Symbols and (premake.action.current() == premake.action.get("vs2017") or premake.action.current() == premake.action.get("vs2019")) then
...
--				_p(3, '<SmallerTypeCheck>true</SmallerTypeCheck>')
		...
		if premake.action.current() == premake.action.get("vs2017") or premake.action.current() == premake.action.get("vs2019") then
