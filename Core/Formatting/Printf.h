...
class null_terminating_iterator {
 public:
  ...
  constexpr null_terminating_iterator &operator=(const Char *ptr) {
    assert(ptr <= end_);
    ptr_ = ptr;
    return *this;
  }
...
void Printf(basic_buffer<Char> &buf, Baroque::StringView format,
...
class basic_printf_context :
 ...
 public:
  /**
   ...
   \endrst
   */
  basic_printf_context(OutputIt out, Baroque::StringView format_str,
...
inline format_arg_store<printf_context, Args...>
  MakePrintfArgs(const Args &... args) { return {args...}; }


template <typename S, typename Char = char>
inline Baroque::String
VSPrintf(const S &format,
         basic_format_args<typename basic_printf_context_t<
           internal::basic_buffer<Char>>::type> args) {
  basic_memory_buffer<Char> buffer;
  Printf(buffer, ToString(format), args);
...
inline FMT_ENABLE_IF_T(
	internal::is_string<S>::value, Baroque::String)
    SPrintf(const S &format, const Args & ... args) {
  internal::check_format_string<Args...>(format);
  typedef internal::basic_buffer<char> buffer;
  typedef typename basic_printf_context_t<buffer>::type context;
  format_arg_store<context, Args...> as{ args... };
  return VSPrintf(ToStringView(format),
...
inline FMT_ENABLE_IF_T(internal::is_string<S>::value, int)
  ...
  typedef typename basic_printf_context_t<buffer>::type context;
  format_arg_store<context, Args...> as{ args... };
  return VFPrintf(f, ToStringView(format),
                  basic_format_args<context>(as));
}
...
inline int VPrintf(const S &format,
                   basic_format_args<typename basic_printf_context_t<
                    internal::basic_buffer<Char>>::type> args) {
  return VFPrintf(stdout, ToStringView(format), args);
}
...
inline FMT_ENABLE_IF_T(internal::is_string<S>::value, int)
  ...
  typedef typename basic_printf_context_t<buffer>::type context;
  format_arg_store<context, Args...> as{ args... };
  return VPrintf(ToStringView(format_str),
                 basic_format_args<context>(as));
}
